...
export function Search(props) {
    ...
    let result = (
        <form action="/" method="get" className="form-inline" onSubmit={onSubmit}>
            <label htmlFor="keyword">Search & Filter Activities:</label>
            ...
            <div className="form-check mb-2 mr-sm-2">
                ...
                <label className="form-check-label" htmlFor="outdoor">outdoor</label>
            </div>
            ...
            <div className="form-check mb-2 mr-sm-4">
                ...
                <label className="form-check-label" htmlFor="indoor">indoor</label>
            </div>
